...
function Navbar() {
  ...
  return (
    <div>
      <div className="px-10 py-5 mx-auto md:px-29 lg:px-20 shadow-md w-full bg-white">
        <div className="relative flex  items-center grid-cols-2 lg:grid-cols-3">
          <ul className="flex items-center space-x-8 lg:flex">
            <li className="hover:bg-slate-100"><a href="/" aria-label="Our product" title="Our product" className="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400 {}" className={router.pathname === '/about' ? 'text-emerald-800' : ''}>About</a></li>
          ...
          <ul className="flex items-center ml-auto space-x-8 lg:flex">
            ...
            <li className="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-black transition duration-200 rounded shadow-md bg-yellow-600 hover:bg-black hover:text-white focus:shadow-outline focus:outline-none">
              <Link
                activeClassName="active"
                to="/signup"
                href="/signup"
